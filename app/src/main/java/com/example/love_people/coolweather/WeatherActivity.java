...
import com.example.love_people.coolweather.service.AutoUpdateService;
import com.example.love_people.coolweather.util.HttpUtil;
import com.example.love_people.coolweather.util.Utility;
...
/**
 * Created by Love_People on 2018/1/4.
 */
...
public class WeatherActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView mWeatherIntoText;
    ...
    private void initView() {
        ...
        mTitleUpdataTime = (TextView) findViewById(R.id.title_update_time);
        mDegreeText = (TextView) findViewById(R.id.degree_text);
        mWeatherIntoText = (TextView) findViewById(R.id.weather_info_text);
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId +
                "&key=9985970024db401bb6cb5f11ed0b75fc";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        mWeatherIntoText.setText(weatherInfo);
